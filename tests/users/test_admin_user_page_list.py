...
from back_app.src.utils.messages import MSG_RESOURCE_FETCHED_PAGINATED, MSG_EXCEPTION
from back_app.src.utils.responses import resp_data_invalid
...
class TestAdminUserPageList:
    ...
    def test_responses_exception_field_not_exist(self, client, mongo):
        ...
        users = db['users']
        users.delete_many({})
        data = dict(foo='bar', full_name='teste', email='teste1@teste.com', password='123456',
